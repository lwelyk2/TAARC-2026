...
#define MOVEMENT_ACTION_HAMHA							0xB6
#define MOVEMENT_ACTION_HIFHIF							0xB7
#define MOVEMENT_ACTION_TACKQ							0xB8
...
#define MOVEMENT_ACTION_DINGBANG						0xBE
#define MOVEMENT_ACTION_KOOCHIQ					 		0xBF
#define MOVEMENT_ACTION_TUGGIE							0xC0
#define MOVEMENT_ACTION_BLUHOO							0xC1
...
#define ANIM_HAMHA (ANIM_STD_COUNT + 20)
#define ANIM_HIFHIF (ANIM_STD_COUNT + 21)
#define ANIM_TACKQ (ANIM_STD_COUNT + 22)
...
#define ANIM_DINGBANG (ANIM_STD_COUNT + 28)
#define ANIM_KOOCHIQ (ANIM_STD_COUNT + 29)
#define ANIM_TUGGIE (ANIM_STD_COUNT + 30)
#define ANIM_BLUHOO (ANIM_STD_COUNT + 31)
