...
enum
{
    ...
    OBJ_EVENT_GFX_BOSS,
    OBJ_EVENT_GFX_CAPPY,
    OBJ_EVENT_GFX_DEXTER,
    OBJ_EVENT_GFX_HOWDY,
    OBJ_EVENT_GFX_JINGLE,
    OBJ_EVENT_GFX_MAXWELL,
    OBJ_EVENT_GFX_OXNARD,
    OBJ_EVENT_GFX_PANDA,
    OBJ_EVENT_GFX_PASHMINA,
    OBJ_EVENT_GFX_PENELOPE,
    OBJ_EVENT_GFX_SANDY,
    OBJ_EVENT_GFX_SNOOZER,
    OBJ_EVENT_GFX_STAN,
    OBJ_EVENT_GFX_HAMTARO_HAMHA,
    OBJ_EVENT_GFX_HAMTARO_TACKQ,
    OBJ_EVENT_GFX_HAMTARO_HIFHIF,
    OBJ_EVENT_GFX_HAMTARO_DIGDIG,
