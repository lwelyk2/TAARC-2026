...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_HAMTARO = 1573,
    SPECIES_HAMTARO_TOUGH = 1574,
    SPECIES_HAMTARO_CUTE = 1575,
    SPECIES_HAMTARO_COOL = 1576,
    SPECIES_HAMTARO_SMART = 1577,
    SPECIES_HAMTARO_BEAUTIFUL = 1578,
    SPECIES_BIJOU = 1579,
    SPECIES_OXNARD = 1580,
    SPECIES_BOSS = 1581,
    SPECIES_MAXWELL = 1582,
    SPECIES_CAPPY = 1583,
    SPECIES_PASHMINA = 1584,
    SPECIES_PENELOPE = 1585,
    SPECIES_HOWDY = 1586,
    SPECIES_DEXTER = 1587,
    SPECIES_SANDY = 1588,
    SPECIES_STAN = 1589,
    SPECIES_PANDA = 1590,
    SPECIES_SNOOZER = 1591,
    SPECIES_JINGLE = 1592,
    SPECIES_PEPPER = 1593,
    SPECIES_LAPIS = 1594,
    SPECIES_LAZULI = 1595,
    SPECIES_HARMONY = 1596,
    SPECIES_SPAT = 1597,
    SPECIES_BARETTE = 1598,
    SPECIES_SEAMORE = 1599,
    SPECIES_HERK_Q_HAM = 1600,
    SPECIES_TEENIE_GIRL = 1601,
    SPECIES_BALLAD_HAM = 1602,
    SPECIES_DOCTOR_HAM = 1603,
    SPECIES_BROSKI = 1604,
    SPECIES_NURSE = 1605,
    SPECIES_SUN_BATHER_HAM = 1606,
    SPECIES_STRAWBERRY_SOCCER_HAM = 1607,
    SPECIES_CUSTOM_END,
