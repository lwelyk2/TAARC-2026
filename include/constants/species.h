...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_JINGLE = 1592,
    SPECIES_PEPPER = 1593,
    SPECIES_OLIVE_OIL_HAM = 1594,
    SPECIES_SHOPKEEPER_HAM = 1595,
    SPECIES_HARMONY = 1596,
    SPECIES_SPAT = 1597,
    SPECIES_HERK_Q_HAM = 1598,
    SPECIES_TEENIE_GIRL = 1599,
    SPECIES_BALLAD_HAM = 1600,
    SPECIES_BROSKI = 1601,
    SPECIES_NURSE = 1602,
    SPECIES_SUN_BATHER_HAM = 1603,
    SPECIES_STRAWBERRY_SOCCER_HAM = 1604,
    SPECIES_CUSTOM_END,
