...
static const u8 sText_WildPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} wants to battle!\p");
static const u8 sText_LegendaryPkmnAppeared[] = _("You encountered {B_OPPONENT_MON1_NAME}!\p");
static const u8 sText_WildPkmnAppearedPause[] = _("{B_OPPONENT_MON1_NAME} wants to battle!{PAUSE 127}");
...
static const u8 sText_GoPkmn[] = _("{B_PLAYER_MON1_NAME} is ready to battle!");
static const u8 sText_GoTwoPkmn[] = _("{B_PLAYER_MON1_NAME} and {B_PLAYER_MON2_NAME} are ready to battle!");
static const u8 sText_GoPkmn2[] = _("{B_BUFF1} is ready to battle!");
...
static const u8 sText_WildPkmnPrefixLower[] = _("");
static const u8 sText_FoePkmnPrefixLower[] = _("");
