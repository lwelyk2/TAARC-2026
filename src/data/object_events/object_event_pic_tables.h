static const struct SpriteFrameImage sPicTable_BrendanNormal[] = {
        ...
        overworld_frame(gObjectEventPic_HamtaroHifHif, 4, 4, 9),
        ...
        overworld_frame(gObjectEventPic_HamtaroTackQ, 4, 4, 7),
        overworld_frame(gObjectEventPic_HamtaroTackQ, 4, 4, 8),
        overworld_frame(gObjectEventPic_HamtaroTackQ, 4, 4, 9),
