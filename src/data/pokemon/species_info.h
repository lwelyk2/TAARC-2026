...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    */
    ...
    [SPECIES_HAMTARO_TOUGH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Hamtaro_Tough,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        ...
        .backPicYOffset = 0,
        .backAnimId = ANIM_CONCAVE_ARC_SMALL,
        .palette = gMonPalette_Hamtaro_Tough,
        .shinyPalette = gMonPalette_Hamtaro_Tough,
        .iconSprite = gMonIcon_Hamtaro,
        .iconPalIndex =0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sHamtaroLevelUpLearnset,
    ...
    [SPECIES_HAMTARO_CUTE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Hamtaro_Cute,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        ...
        .backPicYOffset = 0,
        .backAnimId = ANIM_CONCAVE_ARC_SMALL,
        .palette = gMonPalette_Hamtaro_Cute,
        .shinyPalette = gMonPalette_Hamtaro_Cute,
        .iconSprite = gMonIcon_Hamtaro,
        .iconPalIndex =0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sHamtaroLevelUpLearnset,
    ...
    [SPECIES_HAMTARO_COOL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Hamtaro_Cool,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        ...
        .backPicYOffset = 0,
        .backAnimId = ANIM_CONCAVE_ARC_SMALL,
        .palette = gMonPalette_Hamtaro_Cool,
        .shinyPalette = gMonPalette_Hamtaro_Cool,
        .iconSprite = gMonIcon_Hamtaro,
        .iconPalIndex =0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sHamtaroLevelUpLearnset,
    ...
    [SPECIES_HAMTARO_SMART] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Hamtaro_Smart,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        ...
        .backPicYOffset = 0,
        .backAnimId = ANIM_CONCAVE_ARC_SMALL,
        .palette = gMonPalette_Hamtaro_Smart,
        .shinyPalette = gMonPalette_Hamtaro_Smart,
        .iconSprite = gMonIcon_Hamtaro,
        .iconPalIndex =0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sHamtaroLevelUpLearnset,
    ...
    [SPECIES_HAMTARO_BEAUTIFUL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Hamtaro_Beautiful,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        ...
        .backPicYOffset = 0,
        .backAnimId = ANIM_CONCAVE_ARC_SMALL,
        .palette = gMonPalette_Hamtaro_Beautiful,
        .shinyPalette = gMonPalette_Hamtaro_Beautiful,
        .iconSprite = gMonIcon_Hamtaro,
        .iconPalIndex =0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sHamtaroLevelUpLearnset,
    ...
    [SPECIES_BIJOU] =
    {
        ...
        .shinyPalette = gMonPalette_Bijou,
    ...
    [SPECIES_HERK_Q_HAM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 100, SPECIES_NONE},
                                {EVO_ITEM, ITEM_MOOMOO_MILK, SPECIES_NONE}),
        OVERWORLD(
            sPicTable_Herk_Q_Ham,
            SIZE_32x32,
            SHADOW_SIZE_M,
            TRACKS_NONE,
            sAnimTable_Following,
            gMonPalette_Herk_Q_Ham,
            gMonPalette_Herk_Q_Ham
        )
    },
    ...
    [SPECIES_TEENIE_GIRL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 100, SPECIES_NONE},
                                {EVO_ITEM, ITEM_MOOMOO_MILK, SPECIES_NONE}),
        OVERWORLD(
            sPicTable_Teenie_Girl,
            SIZE_32x32,
            SHADOW_SIZE_M,
            TRACKS_NONE,
            sAnimTable_Following,
            gMonPalette_Teenie_Girl,
            gMonPalette_Teenie_Girl
        )
    },
    ...
    [SPECIES_SUN_BATHER_HAM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 100, SPECIES_NONE},
                                {EVO_ITEM, ITEM_MOOMOO_MILK, SPECIES_NONE}),
        OVERWORLD(
            sPicTable_Sun_Bather_Ham,
            SIZE_32x32,
            SHADOW_SIZE_M,
            TRACKS_NONE,
            sAnimTable_Following,
            gMonPalette_Sun_Bather_Ham,
            gMonPalette_Sun_Bather_Ham
        )
    },
    ...
    [SPECIES_STRAWBERRY_SOCCER_HAM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 100, SPECIES_NONE},
                                {EVO_ITEM, ITEM_MOOMOO_MILK, SPECIES_NONE}),
        OVERWORLD(
            sPicTable_Strawberry_Soccer_Ham,
            SIZE_32x32,
            SHADOW_SIZE_M,
            TRACKS_NONE,
            sAnimTable_Following_Asym,
            gMonPalette_Strawberry_Soccer_Ham,
            gMonPalette_Strawberry_Soccer_Ham
        )
    },
