...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("HAMTARO");
...
const u8 gText_Pokemon[POKEMON_NAME_LENGTH + 1] = _("HAMHAMS");
const u8 gText_Player[] = _("PLAYER"); // Unused
const u8 gText_Pokedex[] = _("HAMDEX"); // Unused
...
const u8 gText_Boy[] = _("HAMTARO");
const u8 gText_Girl[] = _("BIJOU");
...
const u8 gText_TeachWhichPokemon2[] = _("Teach which HamHam?"); // Unused
const u8 gText_ChoosePokemon[] = _("Choose a HamHam.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which HamHam?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which HamHam?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which HamHam?");
...
const u8 gText_NoPokemonForBattle[] = _("No HamHams for battle!");
const u8 gText_ChoosePokemon2[] = _("Choose a HamHam.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} HamHams are needed.");
const u8 gText_PokemonCantBeSame[] = _("HamHams can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose HamHam or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose HamHam and confirm.");
const u8 gText_SendWhichMonToPC[] = _("Send which HamHam to the PC?");
...
const u8 gText_Yes[] = _("YEP-P");
const u8 gText_No[] = _("NO-P");
...
const u8 gText_Pokemon2[] = _("HAMHAMS");
...
const u8 gText_MenuPokemon[] = _("HAMHAMS");
...
const u8 gText_Yes2[] = _("YEP-P");
const u8 gText_No2[] = _("NO-P");
...
const u8 gText_Yes3[] = _("YEP-P");
const u8 gText_No3[] = _("NO-P");
...
const u8 gText_Hamha[] = _("{COLOR RED}HAMHA{COLOR DARK_GRAY}");
const u8 gText_HifHif[] = _("{COLOR RED}HIFHIF{COLOR DARK_GRAY}");
const u8 gText_TackQ[] = _("{COLOR RED}TACKQ{COLOR DARK_GRAY}");
const u8 gText_DigDig[] = _("{COLOR RED}DIGDIG{COLOR DARK_GRAY}");
const u8 gText_Shockie[] = _("{COLOR RED}SHOCKIE{COLOR DARK_GRAY}");
const u8 gText_Dingbang[] = _("{COLOR RED}DINGBANG{COLOR DARK_GRAY}");
const u8 gText_KoochiQ[] = _("{COLOR RED}KOOCHI-Q{COLOR DARK_GRAY}");
const u8 gText_Tuggie[] = _("{COLOR RED}TUGGIE{COLOR DARK_GRAY}");
const u8 gText_Bluhoo[] = _("{COLOR RED}BLUHOO{COLOR DARK_GRAY}");
