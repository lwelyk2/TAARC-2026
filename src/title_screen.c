...
static const u32 sTitleScreenRayquazaGfx[] = INCGFX_U32("graphics/title_screen/hamtarotitle_tiles.png", ".4bpp.smol");
static const u32 sTitleScreenRayquazaTilemap[] = INCGFX_U32("graphics/title_screen/hamtarotitle_tiles.bin", ".smolTM");
...
void CB2_InitTitleScreen(void)
{
    ...
    case 4:
        ...
        SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_MODE_1
                                    ...
                                    | DISPCNT_WIN0_ON
                                    | DISPCNT_OBJWIN_ON);
        m4aSongNumStart(MUS_HAMTAROTIME);
        gMain.state = 5;
        break;
    case 5:
